...
exp_path <- file.path(ps_paths$expeditions, "FJI-2025")  # What expedition are you working on?

# where data comes from and where it goes
raw_dir       <- file.path("G:\\My Drive\\Whitney Goodell Pristine Seas\\DeSSERT\\data\\sub")
